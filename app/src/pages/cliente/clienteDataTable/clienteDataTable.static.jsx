...
export const HeaderWithSearch = ({ setAdicionarEditarCliente }) => {
    const { setFiltrosDataTable, filtrosDataTable } = useClienteContext();
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', gap: '8px' }}>
                ...
                <span className="p-input-icon-left">
                    ...
                    <InputText value={search} onChange={_handleOnChangeSearch} placeholder="Buscar por cliente" />
                </span>
            </div>
            <div>
                <Button
